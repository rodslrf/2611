        ...
        <div class="card-body">
            <div class="info-container">
                <div class="vehicle-info">
                    ...
                    <p><strong>Quantos Km faltam para a revisão:</strong> {{ $veiculo->km_revisao }}</p> - $solicitar->velocimetro_final
                ...
                <div class="qr-code-container">
                    ...
                    <br>
                    <button onclick="imprimirQRCode()" class="btn btn-primary">Imprimir QR Code</button>
                </div>
            </div>
        </div>
